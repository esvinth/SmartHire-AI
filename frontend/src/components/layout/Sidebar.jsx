...
const navItems = [
  ...
  { to: '/skill-gap', label: 'Skill Gap', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
...
export default function Sidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside className={`fixed top-0 left-0 z-30 h-full w-64 bg-white border-r border-gray-200 transform transition-transform lg:translate-x-0 lg:static lg:z-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
